...
class ModelWrapper(abc.ABC):
    ...
    def state_dict(self) -> dict:
        """
        Collects and returns the state_dict from all modules in the wrapper
        with keys preserved from the original model.
        """
        combined_state_dict = {}
        for module in self.modules:
            # Merge the state dicts without modifying the keys
            combined_state_dict.update(module.state_dict())
